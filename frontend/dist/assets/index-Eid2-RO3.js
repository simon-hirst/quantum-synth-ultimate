...
`;document.addEventListener("DOMContentLoaded",async()=>{const l=document.querySelector("#app");if(!l)return;l.innerHTML=`
    <div class="qs-shell">
